...
def build_model(x_train, y_train, x_test, y_test):
    ...
    return model
def build_model_1024(x_train, y_train, x_test, y_test):
...
def create_ensemble(x_train, y_train, x_test, y_test, n_models=5):
    ...
    for i in range(n_models):
        ...
        model=load_model(f'/mnt/c/Users/Nagle2/PycharmProjects/DOA-and-EEG-Project/Saved Model Versions/Regressor/Ensemble/ensemble_model_150__V3.{i}.keras')
...
#testing raw EEG with  DNN
#print(x_train_raw.shape)
#model = build_model_1024(x_train_raw, y_train_raw, x_test_raw, y_test_raw)
#model.save("eeg_regressor_150_raw.keras")

model= load_model("eeg_regressor_150_raw.keras")
print("model trained on raw EEG data:")
evaluate_model(model, x_test_raw, y_test_raw)

#data with EEMD processing
...
#original model
print(x_train.shape)
model= load_model("/mnt/c/Users/Nagle2/PycharmProjects/DOA-and-EEG-Project/Saved Model Versions/Regressor/eeg_regressor_150.keras")
print("model trained on EEMD processed data:")
...
#original model with integrated gradients data
#model = build_model(x_train_pruned, y_train, x_test_pruned, y_test)
#model.save("eeg_regressor_pruned_150.keras")
print("model trained on integrated gradients data")
model= load_model("eeg_regressor_pruned_150.keras")
evaluate_model(model, x_test_pruned, y_test)

n_models=5

#ensemble model with IG
